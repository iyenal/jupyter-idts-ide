...
exports.RestContentProvider = exports.ContentProviderRegistry = exports.Drive = exports.ContentsManager = exports.Contents = void 0;
...
class ContentsManager {
     ...
     */
    getSharedModelFactory(path, options) {
        var _a, _b;
        const [drive] = this._driveForPath(path);
        const provider = (_a = drive.contentProviderRegistry) === null || _a === void 0 ? void 0 : _a.getProvider(options === null || options === void 0 ? void 0 : options.contentProviderId);
        if (provider === null || provider === void 0 ? void 0 : provider.sharedModelFactory) {
            return provider.sharedModelFactory;
        }
        return (_b = drive.sharedModelFactory) !== null && _b !== void 0 ? _b : null;
    }
    /**
...
class Drive {
    ...
    constructor(options = {}) {
        ...
        const restContentProvider = (_d = options.defaultContentProvider) !== null && _d !== void 0 ? _d : new RestContentProvider({
        ...
        this.contentProviderRegistry.fileChanged.connect((registry, change) => {
...
class ContentProviderRegistry {
     ...
     */
    register(identifier, provider) {
        if (this._providers.has(identifier)) {
            throw Error(`Provider with ${identifier} identifier was already registered on this drive`);
        }
        this._providers.set(identifier, provider);
        const fileChangedProxy = (_provider, change) => {
            this._fileChanged.emit(change);
        };
...
exports.ContentProviderRegistry = ContentProviderRegistry;
/**
...
class RestContentProvider {
    ...
    _getUrl(...args) {
        ...
        return coreutils_1.URLExt.join(baseUrl, this._options.apiEndpoint, ...parts);
    }
}
exports.RestContentProvider = RestContentProvider;
