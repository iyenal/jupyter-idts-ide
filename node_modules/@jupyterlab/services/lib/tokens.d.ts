import { ConfigSection, Contents, Event, IContentProvider, Kernel, KernelSpec, NbConvert, ServerConnection, Session, Setting, Terminal, User, Workspace } from '.';
 ...
 */
export declare const IDefaultContentProvider: Token<IContentProvider>;
/**
