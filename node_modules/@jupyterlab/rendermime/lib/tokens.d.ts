 ...
 */
export declare const IUrlResolverFactory: Token<RenderMimeRegistry.IUrlResolverFactory>;
export interface IUrlResolverFactory extends RenderMimeRegistry.IUrlResolverFactory {
}
