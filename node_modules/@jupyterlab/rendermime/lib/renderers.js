 ...
 * @returns A promise which resolves when rendering is complete.
 */
export async function renderLatex(options) {
    // Unpack the options.
...
export async function renderMarkdown(options) {
    ...
    Private.headerAnchors(host, (_a = options.sanitizer.allowNamedProperties) !== null && _a !== void 0 ? _a : false);
}
/**
 ...
 * @returns A promise which resolves when rendering is complete.
 */
export async function renderSVG(options) {
    // Unpack the options.
...
(function (ILinker) {
    ...
    const controlCodes = '\\u0000-\\u0020\\u007f-\\u009f';
    ILinker.webLinkRegex = new RegExp('(?<path>(?:[a-zA-Z][a-zA-Z0-9+.-]{2,' +
 ...
 * @returns A promise which resolves when rendering is complete.
 */
export async function renderError(options) {
    // Unpack the options.
 ...
 * Harden anchor links.
 */
export function hardenAnchorLinks(node, resolver) {
